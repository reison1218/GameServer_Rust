...
type CmdFn = HashMap<u32, fn(&'static mut RankMgr, Packet) -> anyhow::Result<()>, RandomState>;
///排行榜管理器
#[derive(Default)]
pub struct RankMgr {
    pub rank_vec: Vec<RankInfo>, //排行榜数据
    pub update_map: HashMap<u32, &'static mut RankInfo>,
...
impl RankMgr {
    ...
    pub fn invok(&'static mut self, packet: Packet) {
