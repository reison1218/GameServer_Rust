...
impl ::protobuf::Message for S_ROOM {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.err_code != 0 {
            os.write_uint32(3, self.err_code)?;
        }
        if let Some(ref v) = self.room.as_ref() {
...
impl ::protobuf::Message for C_CHOOSE_CHARACTER {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "cter_temp_id",
                |m: &C_CHOOSE_CHARACTER| { &m.cter_temp_id },
                |m: &mut C_CHOOSE_CHARACTER| { &mut m.cter_temp_id },
            ));
...
impl ::protobuf::Message for S_CHOOSE_CHARACTER_NOTICE {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.cter_temp_id != 0 {
            my_size += ::protobuf::rt::value_size(2, self.cter_temp_id, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.cter_temp_id != 0 {
            os.write_uint32(2, self.cter_temp_id)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "cter_temp_id",
                |m: &S_CHOOSE_CHARACTER_NOTICE| { &m.cter_temp_id },
                |m: &mut S_CHOOSE_CHARACTER_NOTICE| { &mut m.cter_temp_id },
            ));
...
impl<'a> ::std::default::Default for &'a C_CHOICE_AI {
    fn default() -> &'a C_CHOICE_AI {
        <C_CHOICE_AI as ::protobuf::Message>::default_instance()
    }
}

impl C_CHOICE_AI {
    pub fn new() -> C_CHOICE_AI {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for C_CHOICE_AI {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.robot_temp_id != 0 {
            my_size += ::protobuf::rt::value_size(2, self.robot_temp_id, ::protobuf::wire_format::WireTypeVarint);
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
        my_size
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.robot_temp_id != 0 {
            os.write_uint32(2, self.robot_temp_id)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "index",
                |m: &C_CHOICE_AI| { &m.index },
                |m: &mut C_CHOICE_AI| { &mut m.index },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "robot_temp_id",
                |m: &C_CHOICE_AI| { &m.robot_temp_id },
                |m: &mut C_CHOICE_AI| { &mut m.robot_temp_id },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<C_CHOICE_AI>(
                "C_CHOICE_AI",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static C_CHOICE_AI {
        static instance: ::protobuf::rt::LazyV2<C_CHOICE_AI> = ::protobuf::rt::LazyV2::INIT;
        instance.get(C_CHOICE_AI::new)
    }
}

impl ::protobuf::Clear for C_CHOICE_AI {
    fn clear(&mut self) {
        self.index = 0;
        self.robot_temp_id = 0;
        self.unknown_fields.clear();
...
impl ::std::fmt::Debug for C_CHOICE_AI {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for C_CHOICE_AI {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
...
impl<'a> ::std::default::Default for &'a S_CHOICE_AI_NOTICE {
    fn default() -> &'a S_CHOICE_AI_NOTICE {
        <S_CHOICE_AI_NOTICE as ::protobuf::Message>::default_instance()
    }
}

impl S_CHOICE_AI_NOTICE {
    pub fn new() -> S_CHOICE_AI_NOTICE {
        ::std::default::Default::default()
    }
...
impl ::protobuf::Message for S_CHOICE_AI_NOTICE {
    fn is_initialized(&self) -> bool {
        true
    }
    ...
    fn new() -> S_CHOICE_AI_NOTICE {
        S_CHOICE_AI_NOTICE::new()
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "index",
                |m: &S_CHOICE_AI_NOTICE| { &m.index },
                |m: &mut S_CHOICE_AI_NOTICE| { &mut m.index },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "robot_temp_id",
                |m: &S_CHOICE_AI_NOTICE| { &m.robot_temp_id },
                |m: &mut S_CHOICE_AI_NOTICE| { &mut m.robot_temp_id },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint32>(
                "user_id",
                |m: &S_CHOICE_AI_NOTICE| { &m.user_id },
                |m: &mut S_CHOICE_AI_NOTICE| { &mut m.user_id },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<S_CHOICE_AI_NOTICE>(
                "S_CHOICE_AI_NOTICE",
                fields,
                file_descriptor_proto()
            )
    ...
    fn default_instance() -> &'static S_CHOICE_AI_NOTICE {
        static instance: ::protobuf::rt::LazyV2<S_CHOICE_AI_NOTICE> = ::protobuf::rt::LazyV2::INIT;
        instance.get(S_CHOICE_AI_NOTICE::new)
    }
}

impl ::protobuf::Clear for S_CHOICE_AI_NOTICE {
    fn clear(&mut self) {
        self.index = 0;
        self.robot_temp_id = 0;
        self.user_id = 0;
...
impl ::std::fmt::Debug for S_CHOICE_AI_NOTICE {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for S_CHOICE_AI_NOTICE {
    fn as_ref(&self) -> ::protobuf::reflect::ReflectValueRef {
        ::protobuf::reflect::ReflectValueRef::Message(self)
    }
}
